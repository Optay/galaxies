galaxies.generator.rawPatterns = [
    ...
    [// Pluto 1-4
        { time: 0, type: "boss", bossType: "insecticlyde" },
        {
            time: 2,
            type: "caption",
            value: "Ooooh, this will sting just a little. Insecticlyde, do my bidding.",
            displayFor: 6
        }
    ],
    [// Neptune 2-1
        { time: 0, duration: 6, startAngle: 0, endAngle: 360, quantity: 4, type: "asteroidice", random: true },
        {
            ...
            endAngle: 360,
            quantity: 4,
            type: ["asteroidice 90", "asteroid 10"],
            random: true
        },
        ...
        { time: 24, type: "ufo", mode: "laser" }, // TEST
        {
            ...
            endAngle: 360,
            quantity: 6,
            type: ["asteroidice 50", "asteroid 50"],
            random: true
        },
        ...
        { time: 34, duration: 0, startAngle: 135, endAngle: 225, quantity: 5, type: "asteroid" },
        {
            ...
            endAngle: 360,
            quantity: 8,
            type: ["asteroidice 75", "asteroid 25"],
            random: true
        },
    ],
    [// Neptune 2-2
        {
            ...
            endAngle: 360,
            quantity: 6,
            type: ["asteroid 80", "asteroidrad 20"],
            random: true
        },
        ...
        { time: 22, duration: 0, startAngle: 180, endAngle: 270, quantity: 5, type: "asteroid" }, // arc
        {
            ...
            endAngle: 360,
            quantity: 6,
            type: ["asteroid 75", "asteroidrad 25"],
            random: true
        },
    ...
    [// Neptune 2-3
        {
            ...
            endAngle: 360,
            quantity: 5,
            type: ["asteroid 40", "asteroidice 20", "asteroidrad 40"],
            random: true
        },
        { time: 3, duration: 0, quantity: 1, type: "powerup", powerup: ["clone", "spread"] },
        {
            ...
            endAngle: 360,
            quantity: 5,
            type: ["asteroid 40", "asteroidice 10", "asteroidrad 50"],
            random: true
        },
        ...
        { time: 24, type: "ufo", mode: "laser" },
        {
            ...
            endAngle: 360,
            quantity: 5,
            type: ["asteroidice 60", "asteroidrad 40"],
            random: true
        },
    ...
    [// Uranus 3-1
        ...
        { time: 7.5, duration: 0, quantity: 1, type: "powerup", powerup: "clone" },
        {
            ...
            endAngle: 360,
            quantity: 2,
            type: ["asteroidrad 90", "asteroid 10"],
            random: true
        },
        ...
        { time: 18, duration: 0, startAngle: 90, endAngle: 160, quantity: 5, type: "asteroid" }, // arc
        {
            ...
            endAngle: 360,
            quantity: 4,
            type: ["asteroidrad 50", "asteroid 50"],
            random: true
        },
        ...
        { time: 30, duration: 5, startAngle: 240, endAngle: 240, quantity: 5, type: "asteroidice" }, // line
        {
            ...
            endAngle: 360,
            quantity: 6,
            type: ["asteroidrad 33", "asteroidice 33", "asteroid 34"],
            random: true
        },
    ],
    [// Uranus 3-2
        ...
        }, // SPIKY
        {
            ...
            endAngle: 360,
            quantity: 5,
            type: ["asteroidrad 20", "asteroidice 50", "asteroid 30"],
            random: true
        },
        ...
        { time: 16.5, duration: 0, quantity: 1, type: "powerup", powerup: "timeWarp" }, // TIMEWARP POWERUP
        {
            ...
            endAngle: 360,
            quantity: 12,
            type: ["asteroidrad 10", "asteroidice 50", "asteroid 40"],
            random: true
        }, // LOTS OF ASTEROIDS
    ...
    [// Uranus 3-3
        {
            ...
            endAngle: 360,
            quantity: 4,
            type: ["asteroidrad 90", "asteroidice 5", "asteroid 5"],
            random: true
        },
        ...
        { time: 4, startAngle: 0, endAngle: 360, quantity: 1, type: "comet", random: true },
        {
            ...
            endAngle: 360,
            quantity: 2,
            type: ["asteroidrad 80", "asteroidice 15", "asteroid 5"],
            random: true
        },
        ...
        { time: 19, duration: 0, quantity: 1, type: "powerup", powerup: "golden" },
        {
            ...
            endAngle: 180,
            quantity: 8,
            type: ["asteroidrad 40", "asteroidice 60"],
            random: true
        },
    ...
    [// Uranus 3-4
        { time: 0, type: "boss", bossType: "monster" },
        {
            time: 2,
            type: "caption",
            value: "You think you can stop me, Luxie? Muhahaha. Unleash the beast.",
            displayFor: 6
        }
    ],
    [// Saturn 4-1
        ...
        }, // SPIKY
        {
            ...
            endAngle: 360,
            quantity: 4,
            type: ["asteroidrad 30", "asteroidice 70"],
            random: true
        },
        ...
        { time: 23.5, duration: 1, startAngle: 0, endAngle: 360, quantity: 5, type: "miniUFO", random: true },
        {
            ...
            endAngle: 360,
            quantity: 6,
            type: ["asteroidrad 10", "asteroidice 80", "asteroid 10"],
            random: true
        }, // LOTS OF ASTEROIDS
        ...
        { time: 26, duration: 0, startAngle: 135, endAngle: 225, quantity: 5, type: "asteroid" }, // arc
        {
            ...
            endAngle: 360,
            quantity: 9,
            type: ["asteroidrad 80", "asteroid 20"],
            random: true
        },
        ...
        },
        {
            ...
            endAngle: 360,
            quantity: 8,
            type: ["asteroidrad 30", "asteroidice 60", "asteroid 10"],
            random: true
        },
    ],
    [// Saturn 4-2
...
/// WHERE I LEFT OFF
        ...
        { time: 38, duration: 0, startAngle: 0, endAngle: -90, quantity: 5, type: "asteroid" }, // arc
        {
            ...
            endAngle: 360,
            quantity: 6,
            type: ["asteroid 20", "asteroidice 50", "asteroidrad 30"],
            random: true
        },
    ...
    [// Saturn 4-3
        {
            ...
            endAngle: 360,
            quantity: 4,
            type: ["asteroid 5", "asteroidice 5", "asteroidrad 90"],
            random: true
        },
        { time: 4, startAngle: 0, endAngle: 360, quantity: 1, type: "comet", random: true },
        {
            ...
            endAngle: 360,
            quantity: 4,
            type: ["asteroid 5", "asteroidice 15", "asteroidrad 80"],
            random: true
        },
        { time: 12, startAngle: 0, endAngle: 360, quantity: 1, type: "comet", random: true },
        ...
        { time: 21, type: "ufo", mode: "laser" },
        {
            ...
            endAngle: 360,
            quantity: 4,
            type: ["asteroid 0", "asteroidice 60", "asteroidrad 40"],
            random: true
        },
        ...
        { time: 64, duration: 0, startAngle: -45, endAngle: -135, quantity: 5, type: "asteroid" }, // arc
        {
            ...
            endAngle: 360,
            quantity: 4,
            type: ["asteroid 50", "asteroidice 0", "asteroidrad 50"],
            random: true
        },
        { time: 72, startAngle: 0, endAngle: 360, quantity: 1, type: "comet", random: true },
        {
            ...
            endAngle: 360,
            quantity: 6,
            type: ["asteroid 0", "asteroidice 70", "asteroidrad 30"],
            random: true
        },
    ],
    [// Saturn 1-4
