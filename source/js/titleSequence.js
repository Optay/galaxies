...
galaxies.TitleSequence = function() {
    ...
    var updateTitleSprite = function() {
        ...
        if (title.material.map) {
            title.scale.set(title.material.map.image.width / titleScale,
                title.material.map.image.height / titleScale,
                1);
        }

        if (titleExtra != null) {
            titleHub.remove(titleExtra);
        }
        titleExtra = titleExtras[currentTitleIndex];
        if (titleExtra != null) {
            titleHub.add(titleExtra);
        }
    };
    ...
    var whooshSound = new galaxies.audio.ObjectSound(galaxies.audio.getSound("titlewoosh"),
        whooshObject,
        5,
        false,
        false);
    ...
    titleExtras[3].scale.set(titleExtras[3].material.map.image.width / 70,
        titleExtras[3].material.map.image.height / 70,
        1);
    ...
    titleExtras[5].scale.set(titleExtras[5].material.map.image.width / 60,
        titleExtras[5].material.map.image.height / 60,
        1);
