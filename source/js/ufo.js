...
this.galaxies.Ufo = function() {
    ...
    var laserChargeParticles = {
        ...
        color: {
            value: [
                new THREE.Color(0.300, 1.000, 0.300),
        ...
        case "laserOrbit":
            ...
            if (stepTimer >= stepTime) {
                ...
                createjs.Tween.get(laserBeam).wait(1000).call(function() {
                        ...
                        createjs.Tween.get(laserBeam.material).to({ opacity: 0 }, 300, createjs.Ease.quadOut).call(
                            function() {
                        ...
                        if (step > 2) {
                            ...
                            galaxies.FX.ShowHit(
                                new THREE.Vector3(Math.cos(anchor.rotation.z), Math.sin(anchor.rotation.z), 0)
                                .multiplyScalar(galaxies.engine.PLANET_DISTANCE),
                                "green");
        ...
        case "tractorBeamOrbit":
            ...
            if (this.commandeeredPlayer) {
                ...
                galaxies.engine.player.baseHeight = galaxies.engine.CHARACTER_POSITION +
                    timeScalar * (1.5 + Math.cos(this.commandeerTime * 35) * 0.2);
    ...
    this.reset = function(mode) {
        ...
        var idleZ = galaxies.engine.CAMERA_Z + 10;
        idlePosition =
            new THREE.Vector3(galaxies.engine.VISIBLE_RADIUS * 1.8,
                0,
                idleZ); //new THREE.Vector3( orbitPosition.x, 0, idleZ );
        //
