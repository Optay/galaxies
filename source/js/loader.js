...
this.galaxies.loadAssets = function( progressCallback, completeCallback, errorCallback ) {
  ...
  var audioItems = [
    ...
    { id: 'monsterouch1', src: 'bosses/occulary/monster_ouch_01', type: createjs.AbstractLoader.BINARY },
    { id: 'monsterroar1', src: 'bosses/occulary/monster_roar_01', type: createjs.AbstractLoader.BINARY },
  ...
  var imageItems = [
    ...
    { id: 'lasercircleblast', src: 'sprites/laser_circle_blast.png' },
