(function() {
    ...
    WAGNER.Composer = function(renderer, settings) {
        ...
        this.front = new THREE.WebGLRenderTarget(1,
            1,
            {
    ...
    WAGNER.Composer.prototype.setSize = function(w, h) {
        ...
        this.camera.projectionMatrix.makeOrthographic(w / - 2,
            w / 2,
            h / 2,
            h / - 2,
            this.camera.near,
    ...
    WAGNER.Pass.prototype.loadShader = function(id, c) {
        ...
        WAGNER.loadShader(WAGNER.fragmentShadersPath + "/" + id,
            function(fs) {
    ...
    WAGNER.Pass.prototype.getOfflineTexture = function(w, h, useRGBA) {
        ...
        var rtTexture = new THREE.WebGLRenderTarget(w,
            h,
            {
    ...
    WAGNER.GenericPass = function(fragmentShaderSource, c) {
        ...
        WAGNER.Pass.call(this);
        var self = this;
        WAGNER.loadShader(WAGNER.vertexShadersPath + "/orto-vs.glsl",
            function(vs) {
                WAGNER.loadShader(fragmentShaderSource,
                    function(fs) {
                        self.shader = WAGNER.processShader(vs, fs);
                        if (c) c.apply(self);
                    });
    ...
    WAGNER.Stack.prototype.updatePasses = function() {
        ...
        this.passItems.forEach(function(passItem, index) {
            ...
            if (passItem.params === undefined) {
                ...
                passItem.params =
                    JSON.parse(JSON.stringify(this.passes[index]
                        .params)); // clone params without reference to the real shader instance params
    ...
    WAGNER.ShadersPool.prototype.getShaderFromPool = function(shaderName, params) {
        ...
        if (shaderName && WAGNER[shaderName]) {
            ...
            if (!pass) {
                ...
                shaderItem = this.addShader(shaderName, params);
    ...
    WAGNER.ShadersPool.prototype.addShader = function(shaderName, params) {
        var pass = new WAGNER[shaderName](params || {}),
            shaderItem = {
                pass: pass,
                name: shaderName,
                used: true
